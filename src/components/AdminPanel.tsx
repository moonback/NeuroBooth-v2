...
export function AdminPanel() {
  const { settings, updateSettings, resetSettings, setScreen, lockAdmin, isOnline } = useApp();
  ...
  return (
    <div className="theme-bg min-h-screen flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-4 sm:px-6 py-6 max-w-4xl mx-auto w-full">
        {tab === 'settings' && <SettingsPanel settings={settings} updateSettings={updateSettings} resetSettings={resetSettings} />}
